  ...
  if (fancynavbar) {
    ...
    if (fancyDropdownMenus.length) {
      ...
      window.resize(function () {
        var fancyDropdownToggles = document.querySelectorAll(Selector.FANCY_DROPDOWN);
        fancyDropdownToggles.forEach(function (el) {
          var fancyDropdownToggle = el;

          if (fancyDropdownToggle.classList.contains(ClassName.SHOW)) {
            var fancyDropdownMenuHeight = "".concat(fancyDropdownToggle.querySelector(Selector.FANCY_DROPDOWN_MENU).offsetHeight, "px");
            fancyDropdownToggle.style.height = fancyDropdownMenuHeight;
          } else {
            fancyDropdownToggle.style.height = "".concat(fancyDropdownToggle.offsetHeight, "px");
          }
        });
      });
    }
